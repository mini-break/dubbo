...
public class NettyServer extends AbstractServer implements Server {
    ...
    protected void doOpen() throws Throwable {
         ...
         * 而且程序死掉以后，内核需要一定的时间才能够释放此端口，不设置SO_REUSEADDR就无法正常使用该端口
         */
        bootstrap.group(bossGroup, workerGroup)
                .channel(NioServerSocketChannel.class)
                .childOption(ChannelOption.TCP_NODELAY, Boolean.TRUE) // channel类型为nio
                .childOption(ChannelOption.SO_REUSEADDR, Boolean.TRUE) // 表示允许重复使用本地地址和端口
